...
class ShaderProgram:
	def __init__(self, game, current_camera):
		self.game = game
	...
	def update_projection_matrix(self):
		# chunk
		self.chunk["m_proj"].write(self.current_camera.m_proj)
		# marker
		self.voxel_marker["m_proj"].write(self.current_camera.m_proj)
		# water
	...
	def update(self):
		...
		self.chunk["m_view"].write(self.current_camera.m_view)
